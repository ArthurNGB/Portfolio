...
import CertItem from "../ui/CertItem";
import { CERTIFICATIONS } from "../../data/certifications";

const Certifications = ({ isLightMode, t, lang, fadeUp }) => (
  <section
    id="certificacoes"
  ...
  >
    {/* Elemento de fundo */}
    <div
      className={`absolute -left-40 top-40 w-96 h-96 blur-[100px] rounded-full pointer-events-none ${
      ...
      >
        <div className="mb-16 md:mb-20">
          <h2 className="text-3xl md:text-4xl font-serif font-bold flex items-center gap-4 antialiased">
            <span className="text-samurai-gold font-mono text-lg">{t.certNum}</span>
            {t.certTitle}
          </h2>
        </div>
