    ...
    <motion.div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-black overflow-hidden">
      ...
      <AnimatePresence>
        {phase === 1 && (
          ...
          >
            {/* Rastro por onde passou reduzido de 5 para 2 elementos e sem sombras complexas */}
            {[...Array(2)].map((_, i) => (
              <motion.div
                key={i}
            ...
            <svg viewBox="0 0 500 50" className="w-full h-full">
              ...
              <path d="M105,26 Q250,21 475,21 L485,24 Q250,27 105,27 Z" fill="#ffffff" />
